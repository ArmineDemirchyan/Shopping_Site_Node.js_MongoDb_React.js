...
const ProductScreen = ({price,name,description,}) => {
    ...
    <div className="productscreen">
      <div className="productscreen__left">
        ...
        <div className="left__info">
          ...
          <p>Description: Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy</p>
        </div>
      </div>
